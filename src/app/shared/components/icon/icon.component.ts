...
const ICON_PATHS: Record<IconName, string> = {
  ...
  'swap': '<polyline points="17 1 21 5 17 9"/><line x1="3" y1="5" x2="21" y2="5"/><polyline points="7 23 3 19 7 15"/><line x1="21" y1="19" x2="3" y2="19"/>'
};
...
export class IconComponent {
  ...
  svgHtml = computed(() => {
    ...
    const svg = `<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="${c}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round">${paths}</svg>`;
